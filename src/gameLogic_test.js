(function () {
  'use strict';
  /*global expect, describe, it, beforeEach, module, inject */
  ...
  describe('checkersLogicService unit tests:', function () {
    ...
    beforeEach(inject(function (_checkersLogicService_) {
      ...
      CONSTANTS = _checkersLogicService_.CONSTANTS;
      ILLEGAL_CODE = _checkersLogicService_.ENUM.ILLEGAL_CODE;
    }));
    ...
    describe('isMoveOk:', function () {
      ...
      describe("INITIAL STATE SCENARIO - BLACK:", function () {
        ...
        it("[2, 1] -> [1, 0]: Illegal because MAN can not move backward",
            ...
            match.turnIndexBeforeMove = BLACK_TURN_INDEX;
            // Empty 4 first
            initialBoard[1][0] = CONSTANTS.DARK_SQUARE;
            match.stateBeforeMove = testState;
      ...
      describe("FIRST STATE SCENARIO - WHITE:", function () {
        ...
        beforeEach(function setTestState() {
          initialBoard[2][1] = CONSTANTS.DARK_SQUARE;
          initialBoard[3][0] = CONSTANTS.BLACK_MAN;
          testState = {
            board: initialBoard,
        ...
        it("[5, 0] -> [6, 1]: Illegal because MAN can not move backward",
            ...
            match.turnIndexBeforeMove = WHITE_TURN_INDEX;
            match.stateBeforeMove = testState;
            testState.board[6][1] = CONSTANTS.DARK_SQUARE;
      ...
      describe('MANDATORY JUMP SCENARIO - BLACK:', function () {
        ...
        beforeEach(function setTestState() {
          ...
          testState.board[3][2] = CONSTANTS.BLACK_KING;
          testState.board[4][5] = CONSTANTS.BLACK_MAN;
          testState.board[5][4] = CONSTANTS.WHITE_KING;
        });
...
//        ['DS', '--', 'DS', '--', 'DS', '--', 'DS', '--']
        ...
        it("[2, 3] -> [1, 4] -> [0, 5]*", function () {
          var match = {};
          match.turnIndexBeforeMove = WHITE_TURN_INDEX;
          testState.board[1][4] = CONSTANTS.BLACK_MAN;
          match.stateBeforeMove = testState;
        ...
        it("[4, 3] -> [3, 4] -> [2, 5]*: Illegal because it does not move to" +
            ...
            var match = {};
            match.turnIndexBeforeMove = WHITE_TURN_INDEX;
            testState.board[3][4] = CONSTANTS.BLACK_MAN;
            match.stateBeforeMove = testState;
      ...
      describe('CONSECUTIVE JUMP SCENARIO FOR WHITE', function () {
        ...
        it("[7, 0] -> [6, 1] -> [5, 2]", function () {
          var match = {};
          match.turnIndexBeforeMove = WHITE_TURN_INDEX;
          testState.board[7][0] = CONSTANTS.WHITE_MAN;
          testState.board[6][1] = CONSTANTS.BLACK_MAN;
          testState.board[4][3] = CONSTANTS.BLACK_MAN;
          match.stateBeforeMove = testState;
        ...
        it("WHITE: [4, 3] -> [3, 2]", function () {
          var match = {};
          match.turnIndexBeforeMove = WHITE_TURN_INDEX;
          testState.board[2][1] = CONSTANTS.BLACK_MAN;
          testState.board[4][3] = CONSTANTS.WHITE_MAN;
          match.stateBeforeMove = testState;
      ...
      describe('TERMINATE TURN WHEN MOVES TO KINGS ROW FOR BLACK', function () {
        ...
        it("[5, 0] -> [6, 1] -> [7, 2]: Test for king", function () {
          var match = {};
          match.turnIndexBeforeMove = BLACK_TURN_INDEX;
          testState.board[5][0] = CONSTANTS.BLACK_KING;
          match.stateBeforeMove = testState;
      ...
      describe('TERMINATE TURN WHEN MOVES TO KINGS ROW FOR WHITE', function () {
        ...
        beforeEach(function setTestState() {
          ...
          testState.board[1][2] = CONSTANTS.BLACK_MAN;
          testState.board[1][4] = CONSTANTS.BLACK_MAN;
        });
      ...
      describe("ENDGAME SCENARIO - BLACK", function () {
        ...
        it("[5, 0] -> [6, 1]: Legal because [7, 0] has no moves", function () {
          ...
          match.stateBeforeMove.board[5][0] = CONSTANTS.BLACK_MAN;
          match.stateBeforeMove.board[5][2] = CONSTANTS.BLACK_MAN;
          match.stateBeforeMove.board[7][0] = CONSTANTS.WHITE_MAN;
        ...
        it("[2, 3] -> [3, 2]: Illegal because the game is not ended.",
            ...
            match.stateBeforeMove.board[2][3] = CONSTANTS.BLACK_MAN;
            match.stateBeforeMove.board[4][1] = CONSTANTS.WHITE_MAN;
      ...
      describe("ENDGAME SCENARIO - WHITE: ", function () {
        ...
        it("[2, 7] -> [1, 6]: Legal because 3 has no moves", function () {
          ...
          match.stateBeforeMove.board[0][7] = CONSTANTS.BLACK_MAN;
          match.stateBeforeMove.board[2][5] = CONSTANTS.WHITE_MAN;
          match.stateBeforeMove.board[2][7] = CONSTANTS.WHITE_MAN;
