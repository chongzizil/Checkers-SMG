(function () {
   ...
   */
  angular.module('myApp').factory('checkersNewAiService',
      ['checkersLogicService', 'alphaBetaService', 'constantService',
        function (checkersLogicService, alphaBetaService, constantService) {
           ...
           */
          function getStateScoreForIndex0(move, turnInde) {
            // getStateValue return the score for player 1.
            return -getStateValue(move[1].set.value, turnInde);
          }
